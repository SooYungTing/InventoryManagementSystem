...
class RegistrationForm:
    def __init__(self, master):
        ...
        self.doe_picker = DateEntry(master, width=12, background='darkblue', foreground='white',
                                    date_pattern='dd/mm/yyyy')
        self.password_entry = tk.Entry(master, show="*")
        self.dob_picker = DateEntry(master, width=12, background='darkblue', foreground='white',
                                    date_pattern='dd/mm/yyyy')
